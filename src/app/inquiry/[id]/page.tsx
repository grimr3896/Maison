    ...
    <div className="min-h-screen bg-stone-50">
      ...
      <main className="max-w-3xl mx-auto pt-24 sm:pt-32 pb-16 sm:pb-20 px-[5%]">
        <div className="mb-8 sm:mb-12">
          <Link href={`/product/${product.id}`} className="inline-flex items-center gap-2 text-[0.6rem] xs:text-[0.65rem] uppercase tracking-widest text-muted-foreground hover:text-primary transition-colors">
